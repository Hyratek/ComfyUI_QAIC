...
class PromptServer():
    def __init__(self, loop):
        ...
        async def system_stats(request):
            ...
            mem_total, mem_total_torch = comfy.model_management.get_total_memory(device, torch_total_too=True)
            mem_free_total, mem_free_torch = comfy.model_management.get_free_memory(device, torch_free_too=True)
